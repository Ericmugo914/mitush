...
<br><br>
<div class="middle" style="  padding:60px; border:1px solid #ED2553;  width:100%; background:grey;">
       <!--tab heading-->
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:green;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#000000;" id="viewitem-tab" data-toggle="tab" href="#viewitem" role="tab" aria-controls="viewitem" aria-selected="true">View Cart</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" style="color:#000000;" id="manageaccount-tab" data-toggle="tab" href="#manageaccount" role="tab" aria-controls="manageaccount" aria-selected="false">Account Settings</a>
          </li>
		  <li class="nav-item">
              <a class="nav-link" style="color:#000000;" id="orders-tab" data-toggle="tab" href="#orders" role="tab" aria-controls="orders" aria-selected="false">Orders</a>
          </li>
                 ...
                 <table class="table">
                  <tbody>
	               <?php
	                ...
	                ?>
                      <tr>
                         <td><image src="../image/clothes/<?php echo $em."/clotheimages/".$res['fldimage'];?>" height="80px" width="100px"></td>
                         <td><?php echo $res['clothename'];?></td>
                         <td><?php echo "Ksh ".$res['cost'];?></td>
                   ...
                   <?php
					  ...
					  <td>
					  <h5><i class="fas fa-dolar-sign"></i>&nbsp;<?php echo end($gtotal); ?></h5>
					  </td>
					  <td>
					  ...
					  <a href="order.php?cust_id=<?php echo $cust_id; ?>"><button type="button" style=" color:white; font-weight:bold; text-transform:uppercase;" class="btn btn-primary">Proceed to checkout</button></a>
					  </td>
					  <td></td>
					  </tr>
...
<!--tab 1 ends-->	   
            ...
            <div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="manageaccount-tab">
			    <form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input type="tel" id="mobile" class="form-control" name="mobile" value="<?php if(isset($fld_mobile)){ echo $fld_mobile;}?>" placeholder="" required>
                    </div>
            ...
            <div class="tab-pane fade" id="orders" role="tabpanel" aria-labelledby="orders-tab">
				...
				<th>Cancel order</th>
					...
					{   
				         $fid=$roww['fld_clothe_id'];
				         $qr=mysqli_query($con,"select * from tbclothes where clothe_id='$fid'");
