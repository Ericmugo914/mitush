...
$re=mysqli_query($con,"select * from tbclothes where fldvendor_id='$Vendorid'");
...
if($re_no)
{
	unset($_SESSION['id']);
	 ...
	 $vend_row=mysqli_fetch_array($vend_info);
	  ...
	  $clothe_img=$re_arr['fldimage'];
	 unlink("image/restaurant/$em/clotheimages/$clothe_img");
	// rmdir("image/restaurant/$em/foodimages");
	 unlink("image/restaurant/$em/$im");
	 //rmdir("image/restaurant/$em");
	 mysqli_query($con,"delete from tbclothes where fldvendor_id='$Vendorid'");
...
else
{
	unset($_SESSION['id']);
	 ...
	 $vend_row=mysqli_fetch_array($vend_info);
	  ...
	  $em=$vend_row['fld_email'];
	 mysqli_query($con,"delete from tblvendor where fldvendor_id='$Vendorid'");
	 unlink("image/clothes/$em/$im");
	 rmdir("image/clothes/$em/clotheimages");
	 rmdir("image/clothes/$em");
